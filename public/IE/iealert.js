...
function initialize($obj, support, title, text){
		...
		if (support === "ie9") { 			// shows the alert msg in IE8, IE7, IE6
			...
			if ($.browser.msie  && parseInt($.browser.version, 11) < 10) {
			...
			if ($.browser.msie  && parseInt($.browser.version, 11) === 6) {
			...
			if ($.browser.msie  && parseInt($.browser.version, 11) < 9) {
			...
			if ($.browser.msie  && parseInt($.browser.version, 11) < 8) {
